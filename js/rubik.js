...
Face.prototype.init = function(cube, type) {
	...
	this._type = type;
	this._color = null;
	var sizeWithOutMargin = Face.SIZE - Face.MARGIN
	this._node = OZ.DOM.elm("div", {className:"face face"+type, width: sizeWithOutMargin+"px", height: sizeWithOutMargin+"px", margin: Face.MARGIN+"px", position:"absolute", left:"0px", top:"0px"});
...
Rubik.prototype.init = function() {
	...
	document.body.children[1].appendChild(this._node);//append rubik's cube to the element of your choice
	
	OZ.CSS3.set(document.body.children[1], "perspective", "460px");
	OZ.CSS3.set(this._node, "transform-style", "preserve-3d");
